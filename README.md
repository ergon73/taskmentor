...
|-----------|------|--------|
| ⭐ | Деплой на Render/Railway | Запланировано |
| ⭐ | REST API для задач (DRF) | Запланировано |
| ⭐ | Google OAuth 2.0 (django-allauth) | Исследование |
| — | Push-уведомления (Firebase + Web Push) | Требует уточнения |
| — | Синхронизация с Google Calendar | Требует уточнения |
| — | Мультитенант / роли | Проектирование |

В текущей MVP-версии аутентификация реализована через встроенную систему Django auth, уведомления — как in-app (модель Notification + бейдж в навигации). Технологии Google OAuth, Firebase Cloud Messaging и Google Calendar API выходят за рамки программы курса и задокументированы как направления развития продукта.
